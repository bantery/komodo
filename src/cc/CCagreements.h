...
/// @param arbitratorfee payment to arbitratorpk required for valid disputes of proposed agreement
...
/// @param firstarbitratorfee arbitrator fee amount defined in the accepted proposal transaction
